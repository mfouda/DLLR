...
input_matrix = reshape(calibc_batch_input,[80*batch_n,batch_pixels]);
%save('F:\code\DLLR\input_matrix.mat','input_matrix');
%% normlized to 0 255
tic 
calibc_batch_input = Normalize_I(calibc_batch_input);
toc
%%
load('F:\code\DLLR\DATA\label.mat')
...
tr_input=tr;
save('F:\code\DLLR\DATA\tr_input.mat','tr_input');
%%
